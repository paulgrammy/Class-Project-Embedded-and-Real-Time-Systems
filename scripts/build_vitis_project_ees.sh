...
mkdir -p ../vitis_project_ees

# run script
xsct build_vitis_project_ees.xsct.tcl

# create .metadata entry for "no new GUI question" if it doesn't exist
METAPATH="../vitis_project_ees/.metadata/.plugins/org.eclipse.core.runtime/.settings/"
...
# run vitis
/home/esr/Xilinx/Vitis/2023.1/bin/vitis -workspace ../vitis_project_ees/ &> /dev/null & disown
